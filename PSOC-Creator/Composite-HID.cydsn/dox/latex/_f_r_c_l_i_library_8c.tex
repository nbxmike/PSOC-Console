...
uint8 \mbox{\hyperlink{_f_r_c_l_i_library_8c_a6e92fe33160f42b842178c512e2beee4}{C\+H\+\_\+\+Device\+Ready}} (void)
\begin{DoxyCompactList}\small\item\em C\+H\+\_\+\+Device\+Ready checks for console input. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{_f_r_c_l_i_library_8c_aa93a3d707cf3f0f26551aca2d1fcfd09}{C\+H\+\_\+\+Put\+String}} (const char $\ast$string)
\begin{DoxyCompactList}\small\item\em C\+H\+\_\+\+Put\+String puts a character string in the send buffer. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{_f_r_c_l_i_library_8c_a1526bb6cce06bc264a9fcee14271bb7a}{C\+H\+\_\+\+Put\+Char}} (char tx\+Data\+Byte)
...
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
8/\+O\+C\+T/2018 Support library for the Free\+R\+T\+OS command line interpreter and port of their C\+LI task to Cypress P\+S\+OC 5\+LP. All the C\+H\+\_\+xxx deal with the C\+LI Human interface device. This will typically be a real or virtual U\+A\+RT device; for the present build it is a U\+SB virtual U\+A\+RT (C\+DC device). 
\end{DoxyDate}
...
C\+H\+\_\+\+Data\+Is\+Ready looks to see if there is user input in the device buffer. In this implementation, it also checks if the U\+SB has be reset by the host and if so will run the init routine. \mbox{\Hypertarget{_f_r_c_l_i_library_8c_a6e92fe33160f42b842178c512e2beee4}\label{_f_r_c_l_i_library_8c_a6e92fe33160f42b842178c512e2beee4}} 
\index{F\+R\+C\+L\+I\+Library.\+c@{F\+R\+C\+L\+I\+Library.\+c}!C\+H\+\_\+\+Device\+Ready@{C\+H\+\_\+\+Device\+Ready}}
\index{C\+H\+\_\+\+Device\+Ready@{C\+H\+\_\+\+Device\+Ready}!F\+R\+C\+L\+I\+Library.\+c@{F\+R\+C\+L\+I\+Library.\+c}}
\subsubsection{\texorpdfstring{C\+H\+\_\+\+Device\+Ready()}{CH\_DeviceReady()}}
{\footnotesize\ttfamily uint8 C\+H\+\_\+\+Device\+Ready (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}



C\+H\+\_\+\+Device\+Ready checks for console input. 

C\+H\+\_\+\+Device\+Ready returns zero unless the system has completed initialization of the C\+LI Human interface device. This does not configure the device, it merely checks status. It is needed to ensure that virtual U\+A\+R\+Ts are started on the host side of a U\+SB C\+DC device, if a harware U\+A\+RT is used then this could be replaced with a macro which always returns 1 (unless there is some error checking or protocol handshake that needs to get done.) \mbox{\Hypertarget{_f_r_c_l_i_library_8c_a10ad974b34fd6e4619050e2e3561b00b}\label{_f_r_c_l_i_library_8c_a10ad974b34fd6e4619050e2e3561b00b}} 
...
{\footnotesize\ttfamily void C\+H\+\_\+\+Put\+Char (\begin{DoxyParamCaption}\item[{char}]{tx\+Data\+Byte }\end{DoxyParamCaption})}
